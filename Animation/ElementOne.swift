...
class ElementOne {
    ...
    func distanceTo(other: ElementOne) -> Double {
...
//    func drawLineWhenOVerlapping(other: ElementOne, on canvas: Canvas) {
//
//        // Calculate the distance between circles
...
//    }
    ...
    // Change direction when overlapping another circle
    func changeDirectionWhenOverlapping(other: ElementOne) {
